...
from ponyFiction.models import Story, Author, Comment, Chapter, Vote, Favorites
from ponyFiction.utils.misc import dthandler, unicode_to_int_list
...
def makeCommentsAjaxResponse(comments_list, data):
    ...
    for cmt in comments_page:
        new_list.append({'comment_id': cmt.pk,
                         ...
                         'story_id': cmt.story_id,
                         'story_title': cmt.story.title,
...
def makeChaptersAjaxResponse(chapters_list, data):
    ...
    for chapter in chapters_page:
        chapter_list_item={
                           ...
                           'author_id': chapter.story.authors.all()[0].id,
                           'author_name': chapter.story.authors.all()[0].username,
